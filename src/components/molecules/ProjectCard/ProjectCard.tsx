    ...
    return (
        <>
            <div className="project-card">
                <div className="project-card__image-wrapper" onClick={handleClick}>
                    <img
                        src={imageUrl}
                    ...
                    {/* Like Badge - Hidden for now */}
                    <div className={`project-card__like-badge hidden ${hasLiked ? 'liked' : ''}`}>
                ...
                {/* Card Info with Like & Share buttons */}
                <div className="project-card__footer">
                    ...
                    <div className="project-card__actions">
                        <button
                            className={`project-card__action-btn ${hasLiked ? 'liked' : ''}`}
                            onClick={handleLike}
                            disabled={hasLiked}
                            aria-label="Like"
                        >
